 ...
 * @author Marko
 */
public class ServletModalidades extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (accion.equalsIgnoreCase("agregar")) {
            ...
            m.setNombre_modalidad(request.getParameter("txtModalidad"));
            OperacionesModalidades om = new OperacionesModalidades();
            om.Create(m);
